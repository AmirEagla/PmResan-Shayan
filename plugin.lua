function run(msg)
	...
	about_key = {{{text = "مهدی" , url = "https://telegram.e/mehdi_fucker"}},{{text = "کانال تیم" , url = "https://telegram.me/bot_saz_chanell"}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/pm_resan_t_bot"}},{{text = "امیرحسین" , url = "https://telegram.me/a_m_i_r_bra"}}}
